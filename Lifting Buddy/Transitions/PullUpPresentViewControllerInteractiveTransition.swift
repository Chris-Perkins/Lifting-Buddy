//
//  PullUpPresentViewControllerInteractiveTransition.swift
//  Lifting Buddy
//
...
open class PullUpPresentViewControllerInteractiveTransition: UIPercentDrivenInteractiveTransition {
    ...
    /// The View Controller that is being transitioned to.
    ...
    ///   - toViewController: The View Controller that should be transitioned to
    ...
    /// Called when `pullableView` is panned on. Uses the amount of panning that has occurred and the space above
    /// `pullableView` as marks of the progress that this transition has made.
    ///
    ...
    @objc private func onPan(pan: UIPanGestureRecognizer) {
        ...
        // This is equal to all of the space above the pullable view, and therefore it is the
        let amountOfScreenToPullUpIn = pullableView.frame.minY
        ...
        let rawProgress = pullUpAmount / amountOfScreenToPullUpIn
        ...
        case .changed:
            ...
            // Check 3 cases:
            // 1. Pull down - don't complete, as the user probably wants to close. (TODO: Sensitivity should go here)
